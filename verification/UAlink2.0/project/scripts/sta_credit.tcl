# Run: UALINK_LIBERTY=... UALINK_NETLIST=... UALINK_PERIOD_NS=0.640 sta -exit scripts/sta_credit.tcl
...
if {[catch {
    ...
    puts "PASS credit setup/hold at period_ns=$env(UALINK_PERIOD_NS); prelayout budget only"
} reason]} {
    puts stderr "FAIL credit STA: $reason"
    exit 1
}
exit 0
