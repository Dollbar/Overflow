# Run: UALINK_TARGET=source UALINK_LIBERTY=/authorized/cold.lib UALINK_BUILD_DIR=/new/result yosys -Q -T -c scripts/map_uart_tx.tcl
...
if {$env(UALINK_TARGET) eq "path"} {
    ...
    puts "UART_TX_MAPPED_MACROS depth=$depth count=$count cell=KD28_SRAM_SDP_${macro_depth}X${macro_width}"
} else {
...
puts "UART_TX_LIBRARY_MAPPING_COMPLETE target=$env(UALINK_TARGET)"
