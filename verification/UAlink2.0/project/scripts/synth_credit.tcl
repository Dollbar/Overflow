# Run: UALINK_LIBERTY=... UALINK_BUILD_DIR=... UALINK_PORTS=4 yosys -c scripts/synth_credit.tcl
# Outputs: mapped.v, mapped.json, area.json; default width=4, capacity=8, init=2.
# Next: analyze this SSG-mapped netlist at all declared corners with sta_credit.tcl.
...
yosys hierarchy -check -top upli_credit_bank
yosys synth -top upli_credit_bank
