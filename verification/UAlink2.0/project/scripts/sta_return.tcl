# Run: UALINK_LIBERTY=... UALINK_NETLIST=... UALINK_PERIOD_NS=0.640 sta -exit scripts/sta_return.tcl
...
if {[catch {
    ...
    link_design upli_credit_return_queue
    ...
    puts "PASS return setup/hold at period_ns=$env(UALINK_PERIOD_NS); prelayout budget only"
} reason]} {
    puts stderr "FAIL return STA: $reason"
    exit 1
}
exit 0
