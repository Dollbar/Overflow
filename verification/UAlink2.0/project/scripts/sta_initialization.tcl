# Run: UALINK_LIBERTY=... UALINK_NETLIST=... UALINK_PERIOD_NS=0.640 sta -exit scripts/sta_initialization.tcl
...
# Identical local IO/load/uncertainty budgets to the connection stage; not PHY requirements.
if {[catch {
    ...
    link_design upli_credit_initializer
    ...
    puts "PASS initialization setup/hold at period_ns=$env(UALINK_PERIOD_NS); prelayout budget only"
} reason]} {
    puts stderr "FAIL initialization STA: $reason"
    exit 1
}
exit 0
