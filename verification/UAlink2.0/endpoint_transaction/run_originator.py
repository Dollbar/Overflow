...
def main():
    ...
    result["source_sha256"][str(__import__('pathlib').Path('verification/endpoint_transaction/run_originator.py'))] = hashlib.sha256(Path(__file__).read_bytes()).hexdigest()
