...
module tb_vector_engine16;
    ...
    vector_fp8_data_t fp8_vector_o;
...
`endif
    ...
    task automatic expect_response(
        ...
        input vector_fp8_data_t expected_fp8,
    ...
    initial begin
        ...
        vector_fp8_data_t expected_fp8;
        vector_fp32_data_t held_fp32;
        vector_fp8_data_t held_fp8;
        ...
        expect_response(VECTOR_ENGINE_OP_EPILOGUE,
                        VECTOR_ENGINE_RESULT_FP32_VECTOR,
                        16'hffff, 8'h20, 1'b0, expected_fp32, 128'h48484848484848484848484848484848,
                        '0, '0, '0, '0, 1'b0);

        scenario_id = 8'd6;
        control_i.output_format = EPILOGUE_OUT_FP8;
        control_i.fp8_format = 1'b0;
        expected_fp8 = 128'h48484848484848484848484848484848;
        start_request(VECTOR_ENGINE_OP_EPILOGUE, 16'hffff, 8'h21, 1'b0);
        expect_response(VECTOR_ENGINE_OP_EPILOGUE,
                        VECTOR_ENGINE_RESULT_FP8_VECTOR,
                        16'hffff, 8'h21, 1'b0, expected_fp32, expected_fp8,
                        '0, '0, '0, '0, 1'b0);
        ...
        expect_response(VECTOR_ENGINE_OP_EPILOGUE,
                        VECTOR_ENGINE_RESULT_FP32_VECTOR,
                        16'hffff, 8'ha0, 1'b0, expected_fp32, expected_fp8, '0,
                        '0, '0, '0, 1'b0);
