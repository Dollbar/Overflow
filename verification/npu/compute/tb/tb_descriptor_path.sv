...
`endif
    ...
    initial begin
        ...
        if ((NPU_TASK_DESCRIPTOR_WIDTH != 342) ||
            (NPU_POST_RESULT_WIDTH != 586)) begin
            $fatal(1,
                "FAIL: package ABI width changed descriptor=%0d post_result=%0d",
                NPU_TASK_DESCRIPTOR_WIDTH, NPU_POST_RESULT_WIDTH);
        end
