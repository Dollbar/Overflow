...
module kdlink_v2_reverse_codec (
    input wire clk_i,
    input wire rst_n_i,
    ...
    always @(*) begin
        tx_body_d = 112'd0;
        tx_body_d[`KDL2_REVERSE_VERSION_LSB +: `KDL2_REVERSE_VERSION_WIDTH] = `KDL2_SCHEMA_VERSION;
        tx_body_d[`KDL2_REVERSE_MESSAGE_TYPE_LSB +: `KDL2_REVERSE_MESSAGE_TYPE_WIDTH] = message_type_i;
        tx_body_d[`KDL2_REVERSE_VC_LSB +: `KDL2_REVERSE_VC_WIDTH] = vc_i;
        tx_body_d[`KDL2_REVERSE_PLANE_ID_LSB +: `KDL2_REVERSE_PLANE_ID_WIDTH] = plane_id_i;
        tx_body_d[`KDL2_REVERSE_SLICE_ID_LSB] = slice_id_i;
        tx_body_d[`KDL2_REVERSE_PHASE_LSB] = phase_i;
        tx_body_d[`KDL2_REVERSE_LINK_EPOCH_LSB +: `KDL2_REVERSE_LINK_EPOCH_WIDTH] = link_epoch_i;
        tx_body_d[`KDL2_REVERSE_SRC_NODE_LSB +: `KDL2_REVERSE_SRC_NODE_WIDTH] = src_node_i;
        tx_body_d[`KDL2_REVERSE_DST_NODE_LSB +: `KDL2_REVERSE_DST_NODE_WIDTH] = dst_node_i;
        tx_body_d[`KDL2_REVERSE_COLLECTIVE_ID_LSB +: `KDL2_REVERSE_COLLECTIVE_ID_WIDTH] = collective_id_i;
        tx_body_d[`KDL2_REVERSE_PACKET_SEQ_LSB +: `KDL2_REVERSE_PACKET_SEQ_WIDTH] = packet_seq_i;
        tx_body_d[`KDL2_REVERSE_CREDIT_DELTA_LSB +: `KDL2_REVERSE_CREDIT_DELTA_WIDTH] = credit_delta_i;
        tx_body_d[`KDL2_REVERSE_CREDIT_TOTAL_LSB +: `KDL2_REVERSE_CREDIT_TOTAL_WIDTH] = credit_total_i;
        tx_body_d[`KDL2_REVERSE_ACK_BITMAP_LSB +: `KDL2_REVERSE_ACK_BITMAP_WIDTH] = ack_bitmap_i;
        tx_body_d[`KDL2_REVERSE_STATUS_LSB +: `KDL2_REVERSE_STATUS_WIDTH] = status_i;
    end
