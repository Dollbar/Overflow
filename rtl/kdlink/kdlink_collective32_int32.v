module kdlink_collective32_int32 #( // 定义三十二节点十六 bank 流式 Ring collective 系统
    ...
    endgenerate
    kdlink_direct_scheduler32 #(.FLITS_PER_CHUNK(FLITS_PER_CHUNK)) u_direct_scheduler (
    ...
    kdlink_fabric32 u_fabric ( // 实例化八 plane 三十二节点逻辑 fabric
    ...
    kdlink_int32_reduce_array512 u_reduce_array ( // 实例化五百一十二 bank 规则化 reduction 阵列
