module kdlink_v2_context_scheduler16 ( // 定义十六 context packet-boundary scheduler
    ...
    input wire [511:0] descriptor_i, // 接收 KDLink-v2 descriptor
    ...
    always @(*) begin // 检查 descriptor、空闲 context 和 runnable winner
        ...
        if (descriptor_i[2:0] > 3'd5 || descriptor_i[15:10] != 6'd32 || descriptor_i[24:21] != 4'd2 || descriptor_i[56:49] == 8'd0 || descriptor_i[58:57] == 2'd0 || descriptor_i[63:62] != 2'd0 || descriptor_i[511:416] != 96'd0) descriptor_valid_d = 1'b0; // 验证 opcode、节点数、版本、资源 mask 和 reserved
