module kdlink_v2_switch32 ( // 定义双 slice 独立数据面的三十二端口 KDSwitch
    ...
    kdlink_v2_switch_slice32 u_slice0 ( // 实例化物理 slice 零独立 switch 数据面
    ...
    kdlink_v2_switch_slice32 u_slice1 ( // 实例化物理 slice 一独立 switch 数据面
