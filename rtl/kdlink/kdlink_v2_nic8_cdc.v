module kdlink_v2_nic8_cdc ( // 定义异步 Tensor 域到一 GHz slice 域的八 plane NIC wrapper
    ...
    input wire [511:0] descriptor_i, // 接收 slice 域 KDLink-v2 descriptor
    ...
    kdlink_v2_nic8 u_nic ( // 实例化 slice 域八 plane NIC
