module kdlink_v2_pcs_rx ( // 定义单 slice 十 lane 64b/66b PCS 接收器
    ...
    kdlink_v2_pcs_deskew10 u_deskew ( // 实例化十 lane 弹性 deskew FIFO
    ...
    generate // 为十 lane 生成独立自同步解扰状态
        for (descrambler_index = 0; descrambler_index < 10; descrambler_index = descrambler_index + 1) begin : g_descrambler // 生成单 PCS lane 解扰器
            kdlink_v2_descrambler64 u_descrambler ( // 实例化单 lane 解扰器
