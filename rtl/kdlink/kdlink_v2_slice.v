module kdlink_v2_slice ( // 定义独立 TX/RX 五百一十二位 KDLink-v2 codec slice
    ...
    kdlink_v2_packetizer u_tx_packetizer ( // 实例化独立 TX packetizer
    ...
    kdlink_v2_depacketizer u_rx_depacketizer ( // 实例化独立 RX depacketizer
...
endmodule // 结束 KDLink-v2 codec slice
