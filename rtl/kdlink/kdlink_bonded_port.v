module kdlink_bonded_port ( // 定义双 slice 全双工 bonded port
    ...
    kdlink_replay_buffer u_replay0 ( // 实例化 slice 零独立 replay 状态
    ...
    kdlink_replay_buffer u_replay1 ( // 实例化 slice 一独立 replay 状态
    ...
    kdlink_bonded_tx_register u_tx_register ( // 实例化 shared arbitration 到 codec 的独立时序分区
    ...
    kdlink_slice u_slice0 ( // 实例化 physical slice 零独立 codec
    ...
    kdlink_slice u_slice1 ( // 实例化 physical slice 一独立 codec
    ...
    kdlink_bonded_reorder u_reorder ( // 实例化 bonded port 全局顺序恢复窗口
