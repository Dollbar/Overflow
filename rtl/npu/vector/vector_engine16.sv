...
module vector_engine16 #(
    ...
    output vector_pkg::vector_mx_data_t                    mx_vector_o,
    output mxfp_pkg::mxfp_scale_t                          mx_scale_o,
    ...
    logic epilogue_raw_output_valid;
    logic epilogue_raw_output_ready;
    vector_pkg::vector_engine_result_t epilogue_raw_output;
    ...
    always_comb begin
        ...
        epilogue_control_i.mx_format = control_i.mx_format;
    ...
    always_comb begin
        ...
        producer_result[1].control.mx_format = epilogue_control_o.mx_format;
        producer_result[1].control.result_kind =
            (epilogue_control_o.output_format == vector_pkg::EPILOGUE_OUT_MX) ?
    ...
    vector_engine_result_fifo #(.DEPTH(20)) u_epilogue_result_fifo (
        ...
        .output_valid_o(epilogue_raw_output_valid),
        .output_ready_i(epilogue_raw_output_ready),
        .output_result_o(epilogue_raw_output)
    );

    vector_epilogue_mx_adapter u_epilogue_mx_adapter (
        .clk_i(clk_i), .rst_i(rst_i), .clear_i(clear_i),
        .input_valid_i(epilogue_raw_output_valid),
        .input_ready_o(epilogue_raw_output_ready),
        .input_result_i(epilogue_raw_output),
    ...
    always_comb begin
        ...
        mx_vector_o = response_q.mx_vector;
        mx_scale_o = response_q.mx_scale;
