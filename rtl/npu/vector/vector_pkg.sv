...
package vector_pkg;
    ...
    localparam int unsigned VECTOR_MX_DATA_WIDTH = VECTOR_LANES * 8;
    localparam int unsigned VECTOR_TAG_WIDTH = 8;

    typedef logic [VECTOR_DATA_WIDTH-1:0] vector_fp32_data_t;
    typedef logic [VECTOR_MX_DATA_WIDTH-1:0] vector_mx_data_t;
    ...
    typedef enum logic [1:0] {
        ...
        VECTOR_ENGINE_RESULT_MX_VECTOR   = 2'd1,
