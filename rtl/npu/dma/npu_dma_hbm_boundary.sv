...
module npu_dma_hbm_boundary #(
    ...
    localparam int unsigned ALLOCATOR_CAPTURE_GROUP =
    ...
    assign allocator_release_commit = response_delivered &
    ...
    generate
        for (genvar channel_index = 0; channel_index < CHANNELS;
            ...
            assign allocator_allocation_request[channel_index] =
                buffer_accept_control[
                    channel_index*CAPTURE_CONTROL_COPIES +
                    ALLOCATOR_CAPTURE_GROUP];
    ...
    npu_dma_local_tag_allocator #(
        ...
        .release_local_tag_i(channel_response_local_tag_o),
    ...
    npu_dma_hbm_tag_tracker #(
        ...
        .clk_i,
        .rst_i,
        .allocation_commit_i(buffer_dequeue),
        .allocation_local_tag_i(buffer_local_tag_q),
        .allocation_permitted_o(tracker_allocation_permitted),
        .retirement_commit_i(response_delivered),
        .retirement_local_tag_i(channel_response_local_tag_o),
