...
| NPU-NOC-001 | `noc/` | Credit-based router with deterministic escape VC | ADR-0005 + ADR-0008 + NoC Router contract | VERIFIED: lint + GENERIC_SYNTH + RTL_SIM + bounded FORMAL | FIFO/credit/lock proofs + merged coverage gate |
