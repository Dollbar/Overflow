...
// 85-bit parallel-prefix adder for the exact cross-K Q32 accumulator.
module kogge_stone_adder_85 (
    ...
    logic [83:0] propagate_l1;
    logic [83:0] generate_l1;
    logic [83:0] propagate_l2;
    logic [83:0] generate_l2;
    logic [83:0] propagate_l3;
    logic [83:0] generate_l3;
    logic [83:0] propagate_l4;
    logic [83:0] generate_l4;
    logic [83:0] propagate_l5;
    logic [83:0] generate_l5;
    logic [83:0] propagate_l6;
    logic [83:0] generate_l6;
    logic [83:0] propagate_l7;
    ...
    assign propagate_l1[83:1] = propagate_l0[83:1] & propagate_l0[82:0];
    ...
    assign propagate_l2[83:2] = propagate_l1[83:2] & propagate_l1[81:0];
    ...
    assign propagate_l3[83:4] = propagate_l2[83:4] & propagate_l2[79:0];
    ...
    assign propagate_l4[83:8] = propagate_l3[83:8] & propagate_l3[75:0];
    ...
    assign propagate_l5[83:16] = propagate_l4[83:16] & propagate_l4[67:0];
    ...
    assign propagate_l6[83:32] = propagate_l5[83:32] & propagate_l5[51:0];
    ...
    assign propagate_l7[83:64] = propagate_l6[83:64] & propagate_l6[19:0];
    assign generate_l7[83:64] = generate_l6[83:64] |
                                 (propagate_l6[83:64] & generate_l6[19:0]);

    assign carry[0] = cin_i;
    assign carry[84:1] = generate_l7 | (propagate_l7 & {84{cin_i}});
