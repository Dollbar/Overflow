...
module fp8_fused_reduce4 #(
    ...
    logic [66:0] abs_input_comb;
    logic [66:0] magnitude_comb;
    logic finite_sign_comb;
    logic [66:0] magnitude_s6_q;
    ...
    logic [66:0] coarse_magnitude_comb;
    ...
    logic [66:0] coarse_magnitude_s8_q;
    ...
    logic invalid_s10_q;
    fp8_pkg::fp8_rounding_e rounding_s10_q;
    logic valid_s10_q;
    ...
    assign csa_sum_l2_comb = csa_sum_l1_s3_q ^ csa_carry_l1_s3_q ^ signed_pattern3_s3_q;
    ...
    assign abs_input_comb = exact_sum_s5_q ^ {67{exact_sum_s5_q[66]}};

    kogge_stone_adder_67 u_absolute_value_adder (
        .a_i   (abs_input_comb),
        .b_i   (67'd0),
        .cin_i (exact_sum_s5_q[66]),
        .sum_o (magnitude_comb)
    );

    always_comb begin
        finite_sign_comb = exact_sum_s5_q[66];
        if (exact_sum_s5_q == 67'd0) begin
    ...
    fp8_fixed67_lzc u_fixed67_lzc (
        .magnitude_i (magnitude_s6_q),
        .nonzero_o   (nonzero_comb),
        .msb_index_o (msb_index_comb)
    );

    fp8_fixed67_normalize_coarse u_normalize_coarse (
    ...
    fp8_fixed67_normalize_fine u_normalize_fine (
    ...
    fp8_reduce4_round_prepare u_round_prepare (
