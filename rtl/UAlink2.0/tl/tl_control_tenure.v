...
6'd32,6'd33,6'd34: s7=2'd2; // 特殊命令BE尚待专节确认
...
6'd38,6'd40,6'd42,6'd44,6'd45,6'd46,6'd47,6'd60,6'd61,6'd62,6'd63: begin // 并行字段派生逻辑
...
6'd3,6'd4,6'd5,6'd8,6'd9,6'd10,6'd11,6'd12,6'd13,6'd14,6'd15: begin end // 读请求不附带数据
6'd32,6'd33,6'd34: s3=2'd2; // 特殊命令BE尚待专节确认
6'd48,6'd50,6'd51: begin // 标准原子固定一Beat
