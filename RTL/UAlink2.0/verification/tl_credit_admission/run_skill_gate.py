"""Run: python3 verification/tl_credit_admission/run_skill_gate.py --skill-root PATH.
...
R=Path(__file__).resolve().parents[2];S=R/'build/verification/tl_credit_admission';D=S/'authored';D.mkdir(exist_ok=True)
