...
This isolated subtree imports 834 tracked files from Dollbar/KD-UAlink2.0 commit
`4a6ccf5037505b859e821d43e4f484cee06d9b0e`. The exact source hashes are in
...
The Endpoint and Switch development tops exist and have RTL_SIM and GENERIC_SYNTH
evidence described in [the bring-up guide](docs/ip_top_bringup.md). The inventory
contains 202 RTL entries: 57 partially implemented modules and 145 disabled interface
...
make ip-top-smoke KD28_ROOT=../.. IP_RUN_LABEL=imported_tops
```
