# Run: sta -exit scripts/sta_tl_control_partition.tcl with UALINK_LIBERTY,
...
# Next: run check_sta_report.py --design control_partition and bind to the exact mapped artifact.
...
if {[catch {
    ...
    link_design tl_control_partition
    ...
    puts "PASS control_partition setup/hold at period_ns=$env(UALINK_PERIOD_NS); prelayout budget only"
} reason]} {
    puts stderr "FAIL control partition STA: $reason"
    exit 1
}
exit 0
