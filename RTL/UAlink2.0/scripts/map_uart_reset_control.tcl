# Run: UALINK_CLOCK_PERIOD_PS=640 UALINK_LIBERTY=/authorized/cold.lib UALINK_BUILD_DIR=/new/result yosys -Q -T -c scripts/map_uart_reset_control.tcl
...
puts "UART_RESET_LIBRARY_MAPPING_COMPLETE configured_period_ps=$env(UALINK_CLOCK_PERIOD_PS) response_depth=4"
