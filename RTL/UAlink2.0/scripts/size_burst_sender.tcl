# Run: sta -exit scripts/size_burst_sender.tcl with explicit UALINK_LIBERTY,
...
if {[catch {
    ...
    close $journal_file
    puts "DONE sender sizing changes=$changes; equivalence and all-corner STA still required"
} reason]} {
    puts stderr "FAIL sender sizing: $reason"
    exit 1
}
exit 0
