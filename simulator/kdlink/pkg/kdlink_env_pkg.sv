package kdlink_env_pkg;
    localparam int unsigned KDLINK_CARD_SLOTS = 8;
    localparam int unsigned KDLINK_NPUS_PER_CARD = 4;
    ...
    localparam int unsigned KDLINK_SLICES_PER_CARD = 64;
    ...
    function automatic int unsigned kdlink_endpoint_index(
        ...
        kdlink_endpoint_index =
            (((slot_id * KDLINK_NPUS_PER_CARD) + local_npu) * KDLINK_SLICES_PER_NPU) +
