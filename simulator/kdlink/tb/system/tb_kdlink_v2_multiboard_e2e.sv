`timescale 1ns/1ps
module tb_kdlink_v2_multiboard_e2e;
    ...
    kdlink_v2_replay_buffer #(.ENTRIES(8), .INDEX_WIDTH(3)) u_replay (
    ...
    initial begin
        ...
        $display("TB_KDLINK_V2_MULTIBOARD_E2E_PASS cards=8 representative_endpoints=2 packets=%0d crc_bad=1 nack=1 rtl_replay=1 exact_once=1 pcs=1 serdes=1",
            NORMAL_PACKETS);
        $finish;
    end
    ...
    initial begin
        #12000;
        $fatal(1, "KDLink-v2 multiboard E2E timeout");
    end
endmodule
