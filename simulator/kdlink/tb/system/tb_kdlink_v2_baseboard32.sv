`timescale 1ns/1ps
module tb_kdlink_v2_baseboard32;
    ...
    kdlink_v2_baseboard32_model u_dut (
    ...
    initial begin
        ...
        $display("TB_KDLINK_V2_BASEBOARD32_PASS cards=8 npus_per_card=4 nodes=32 planes=8 slices=512 cycles=%0d flits_per_cycle=512 bubbles=0 card_isolation=1 plane_isolation=1 slice_isolation=1",
            MEASURE_CYCLES);
        $finish;
    end
    ...
    initial begin
        #5000;
        $fatal(1, "KDLink-v2 baseboard32 timeout");
    end
endmodule
