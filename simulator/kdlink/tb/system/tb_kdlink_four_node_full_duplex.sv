...
module tb_kdlink_four_node_full_duplex;
    ...
    initial begin
        #300000;
        $fatal(1, "KDLink four-node full-duplex timeout");
    end
endmodule
