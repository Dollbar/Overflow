...
module tb_kdlink_direct32;
    ...
    kdlink_collective32_int32 #(.FLITS_PER_CHUNK(FLITS_PER_CHUNK)) u_dut (
    ...
    initial begin
        ...
        $display("TB_KDLINK_DIRECT32_PASS a2a_cycles=%0d a2av_cycles=%0d p2p_cycles=%0d a2a_payload_cycles=%0d a2a_bubbles=%0d a2a_effective_GBps_per_node=%0.3f", a2a_cycles, a2av_cycles, p2p_cycles, a2a_payload_cycles, a2a_bubbles, a2a_effective_gbps);
        $finish;
    end

    initial begin
        #200000;
        $fatal(1, "KDLink direct32 timeout");
    end
endmodule
