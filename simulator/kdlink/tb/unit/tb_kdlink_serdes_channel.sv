`timescale 1ns/1ps
module tb_kdlink_serdes_channel;
    ...
    initial begin
        ...
        $display("TB_KDLINK_SERDES_CHANNEL_PASS groups=%0d lanes=10 propagation=3 max_skew=2 bubbles=0 drops=3 corruptions=3 flushes=2 retrain=2",
            NOMINAL_GROUPS);
        $finish;
    end
    ...
    initial begin
        #3000;
        $fatal(1, "KDLink SerDes channel timeout");
    end
endmodule
