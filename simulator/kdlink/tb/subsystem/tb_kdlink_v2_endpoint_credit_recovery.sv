...
module tb_kdlink_v2_endpoint_credit_recovery;
    logic coll_clk;
    logic phy_clk;
    logic rst_n;
    ...
    initial begin
        ...
        $display("TB_KDLINK_V2_ENDPOINT_CREDIT_RECOVERY_PASS credit_exhausted=1 credit_recovered=1 crc_fault=1 nack=1 replay=1 commits=2 control_vc=1 async_clocks=1 forward_flits=%0d replay_empty=%b",
    ...
    initial begin
        #30000;
        $fatal(1, "KDLink-v2 endpoint credit recovery timeout");
    end
endmodule
