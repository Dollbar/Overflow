...
module tb_kdlink_reverse_ctrl;
    ...
    initial begin
        ...
        $display("TB_KDLINK_REVERSE_CTRL_PASS messages=%0d vcs=8 types=7 tx_gaps=%0d crc_kat=PASS crc_fault=PASS epoch_reject=PASS identity_reject=PASS", received_count, tx_gap_count);
        $finish;
    end

    initial begin
        #10000;
        $fatal(1, "KDLink reverse control timeout");
    end
endmodule
