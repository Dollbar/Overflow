`timescale 1ns/1ps
module tb_kdlink_serdes_pcs_link;
    ...
    initial begin
        ...
        $display("TB_KDLINK_SERDES_PCS_LINK_PASS directions=2 data_flits_per_direction=%0d propagation=4 max_skew=2 bubbles=0 corruption_detected=1",
            DATA_FLITS);
        $finish;
    end
    ...
    initial begin
        #5000;
        $fatal(1, "KDLink SerDes PCS link timeout");
    end
endmodule
